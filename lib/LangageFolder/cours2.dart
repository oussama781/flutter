import 'package:cours/widgets/desctiption_section2.dart';
import 'package:cours/widgets/videos_section2.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class cours2 extends StatefulWidget {
  String img;
  cours2(this.img);

  @override
  State<cours2> createState() => _cours2();
}

class _cours2 extends State<cours2> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 15),
            Text(
              "Aprrendre les Base de Langage C Niveau 2",
              style: TextStyle(
                fontSize: 20,
            ...
            isVideoSection ? VideoSection2() : DescriptionSection2(),
          ],
        ),
      ),
    );

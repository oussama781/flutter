import 'package:cours/widgets/desctiption_section4.dart';
import 'package:cours/widgets/videos_section4.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class cours4 extends StatefulWidget {
  String img;
  cours4(this.img);

  @override
  State<cours4> createState() => _cours3();
}

class _cours3 extends State<cours4> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 15),
            Text(
              "Aprrendre La Programmation Systeme avec C",
              style: TextStyle(
                fontSize: 20,
            ...
            isVideoSection ? VideoSection4() : DescriptionSection4(),
          ],
        ),
      ),
    );
